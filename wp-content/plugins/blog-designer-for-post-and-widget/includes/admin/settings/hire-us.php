...
<div class="wrap">
	...
	<h2><?php _e( 'Hire Us - Get unlimited expert WordPress Support and Development', 'blog-designer-for-post-and-widget' ); ?></h2><br />

	<div class="support-data">
	<h3 style="margin-bottom:5px;"><?php _e( 'Highlight of Hiring:', 'blog-designer-for-post-and-widget' ); ?></h3>
		<ul>
		 	<li><?php _e( 'Hire once, get unlimited jobs done', 'blog-designer-for-post-and-widget' ); ?></li>				 	
		 	<li><?php _e( 'Quick ticket support, quick solution', 'blog-designer-for-post-and-widget' ); ?></li>
		 	<li><?php _e( 'Any sort of WP work with no extra cost', 'blog-designer-for-post-and-widget' ); ?></li>
		 	<li><?php _e( 'Dedicated expert working only for you!', 'blog-designer-for-post-and-widget' ); ?></li>
		</ul>
	</div>	
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		<th>
	    			<h2><?php _e( 'Hire us for 1 Hr', 'blog-designer-for-post-and-widget' ); ?></h2>
	    			<p><?php _e( '$20 USD', 'blog-designer-for-post-and-widget' ); ?></p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 5 Hrs', 'blog-designer-for-post-and-widget' ); ?></h2>
	    			<p><?php _e( '$99 USD', 'blog-designer-for-post-and-widget' ); ?></p>
	    		</th>
	    		<th>
	    			<h2><?php _e( 'Hire us for 30 Hrs', 'blog-designer-for-post-and-widget' ); ?></h2>
	    			<p><?php _e( '$499 USD', 'blog-designer-for-post-and-widget' ); ?></p>
	    			<p class="promo"><?php _e( 'Our most valuable package!', 'blog-designer-for-post-and-widget' ); ?></p>
	    		</th>
				<th>
	    			<h2><?php _e( 'Hire us for 70 Hrs', 'blog-designer-for-post-and-widget' ); ?></h2>
	    			<p><?php _e( '$999 USD', 'blog-designer-for-post-and-widget' ); ?></p>
	    		</th>	
	    	</tr>
	    </thead>
	    ...
	    <tfoot>
	    	<tr>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=6&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'blog-designer-for-post-and-widget' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'blog-designer-for-post-and-widget' ); ?></a></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=4&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'blog-designer-for-post-and-widget' ); ?></a></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=6044&edd_options[price_id]=5&ref=wposthemeplugin" target="_blank"><?php _e( 'Hire Us', 'blog-designer-for-post-and-widget' ); ?></a></td>
			</tr>
	    </tfoot> 
	</table>
</div>