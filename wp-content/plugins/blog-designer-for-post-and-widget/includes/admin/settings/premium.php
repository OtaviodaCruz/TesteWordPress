	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
				...
				<a href="https://www.wponlinesupport.com/wp-plugin/blog-designer-post-and-widget/?ref=WposPratik&utm_source=WP&utm_medium=Blog-Designer&utm_campaign=Upgrade-PRO" class="wpos-button" target="_blank"><?php _e( 'View Pricing Options', 'blog-designer-for-post-and-widget' ); ?></a></td>
	    	</tr>
	    </tfoot>
		<tbody>
			<tr>
			...
			<tr>
			<th><?php _e( 'Visual Composer/WPBakery Page Builder Supports ', 'blog-designer-for-post-and-widget' ); ?><span class="subtext"><?php _e( 'Use this plugin with Visual Composer/WPBakery page builder easily', 'blog-designer-for-post-and-widget' ); ?></span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
